...
export default function ConteudosPage() {
  ...
  return <main className="site-shell"><SiteHeader />
    ...
    <section className="section social-section"><div className="container">
      ...
      <div className="social-feed-shell"><div className="feed-heading"><div><p className="eyebrow"><span /> Facebook integrado</p><h2>Publicações recentes</h2></div><span className="feed-status connected">Perfil oficial conectado</span></div><div className="facebook-feed"><iframe title="Publicações da LESystems no Facebook" src={`https://www.facebook.com/plugins/page.php?href=${facebookPage}&tabs=timeline&width=500&height=680&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false`} width="500" height="680" loading="lazy" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" /></div><p className="integration-note">O conteúdo é carregado diretamente pelo Facebook. Se a rede solicitar login ou bloquear a visualização, o botão “Ver perfil oficial” continuará disponível.</p></div>
    </div></section>
