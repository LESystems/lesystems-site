...
export default function SiteHeader() {
  return <header className="site-header">
    ...
    <div className="container nav-row">
      ...
      <Link href="/" className="brand" aria-label="LESystems — início"><span className="brand-frame"><Image src="/icon.png" alt="LESystems" width={256} height={256} priority /></span></Link>
      <nav className="desktop-nav" aria-label="Navegação principal"><Link href="/">Início</Link><Link href="/empresa">Empresa</Link><Link href="/servicos">Serviços</Link><Link href="/portfolio">Portfólio</Link><Link href="/conteudos">Conteúdos</Link><Link href="/noticias">Notícias</Link><Link href="/suporte">Suporte</Link><Link className="hub-access-link" href="/hub">Hub <ArrowIcon /></Link><Link className="button button-small" href="/criar-projeto">Criar projeto <ArrowIcon diagonal /></Link></nav>
      <details className="mobile-menu"><summary aria-label="Abrir menu"><span /><span /><span /></summary><nav><Link href="/">Início</Link><Link href="/empresa">Empresa</Link><Link href="/servicos">Serviços</Link><Link href="/portfolio">Portfólio</Link><Link href="/conteudos">Conteúdos</Link><Link href="/noticias">Notícias</Link><Link href="/agendamento">Agendamento</Link><Link href="/suporte">Suporte</Link><Link className="mobile-hub-link" href="/hub">LESystems Hub <ArrowIcon /></Link><Link href="/criar-projeto">Criar meu projeto</Link><Link href="/contato">Contato</Link></nav></details>
    </div>
  </header>;
}
