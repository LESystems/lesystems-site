...
export default function SiteHeader() {
  return <header className="site-header">
    ...
    <div className="container nav-row">
      ...
      <nav className="desktop-nav" aria-label="Navegação principal"><Link href="/">Início</Link><Link href="/empresa">Empresa</Link><Link href="/servicos">Serviços</Link><Link href="/conteudos">Conteúdos</Link><Link href="/noticias">Notícias</Link><Link href="/suporte">Suporte</Link><Link className="button button-small" href="/contato">Fale conosco <ArrowIcon diagonal /></Link></nav>
