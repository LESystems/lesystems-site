...
export type CommerceProject = { id:string; code:string; name:string; project_type:string; status:string; progress:number; created_at:string; previewUrl:string | null; proposal:null | { id:string; amountCents:number; status:string; description:string } };
