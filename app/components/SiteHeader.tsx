...
export default function SiteHeader() {
  return <header className="site-header">
    ...
    <div className="container nav-row">
      ...
      <Link href="/" className="brand" aria-label="LESystems — início"><span className="brand-frame"><Image src="/logo-lesystems.png" alt="LESystems" width={1254} height={1254} priority /></span><span className="brand-copy"><strong>LESystems</strong><small>Soluções digitais com inteligência e inovação</small></span></Link>
